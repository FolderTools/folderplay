...
Cloudflare Pages con wrangler (`wrangler pages deploy dist --project-name=miusic`).
Es un proyecto de "Direct Upload" con dos dominios: `folderplay.com` (el bueno,
canónico) y `miusic.pages.dev`. Requiere HTTPS porque la File System Access API
solo funciona en contextos seguros.
